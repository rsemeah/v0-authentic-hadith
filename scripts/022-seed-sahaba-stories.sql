...
INSERT INTO sahaba (name_en, name_ar, title, era, bio_summary, icon_emoji, color, bg_color, total_parts, slug)
VALUES (
  'Abu Bakr as-Siddiq',
  'أبو بكر الصديق',
  'The Truthful One',
  'Early Islam - First Caliph',
  'The closest companion of the Prophet (peace be upon him), first adult male to accept Islam, and the first Caliph of the Muslim Ummah. Known for his unwavering faith, generosity, and gentle leadership.',
  'shield',
  'text-[#1B5E43]',
  'bg-[#1B5E43]/10',
  5,
...
INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 1, 'Before the Light',
...
INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 2, 'The First to Believe',
...
'["Sahih al-Bukhari 3661", "Ibn Hisham, Sirah", "Sahih al-Bukhari 3544"]', 5
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 3, 'The Cave and the Migration',
...
'["Sahih al-Bukhari 3615", "Quran 9:40", "Sahih al-Bukhari 3653"]', 5
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 4, 'Standing Firm When the World Shook',
...
'["Sahih al-Bukhari 3667", "Quran 3:144", "Sahih al-Bukhari 1241"]', 5
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 5, 'The Legacy of the Truthful',
...
The Prophet (peace be upon him) had said: "If I were to take a Khalil (intimate friend) other than my Lord, I would have taken Abu Bakr. But the brotherhood and love of Islam is sufficient. Let no door of the mosque remain open except the door of Abu Bakr."
...
'["Sahih al-Bukhari 1400", "Sahih al-Bukhari 3904", "Quran 12:101", "Sunan Abu Dawud 4652"]', 5
FROM sahaba WHERE slug = 'abu-bakr';
...
VALUES (
  ...
  'Early Islam - Second Caliph',
  'From fierce enemy of Islam to its greatest administrator. Umar''s conversion strengthened the Muslims immeasurably, and his rule as second Caliph established justice and governance principles that shaped civilization.',
  'sword',
  'text-[#8B4513]',
  'bg-[#8B4513]/10',
  5,
...
Allah chose Umar.',
'["Jami at-Tirmidhi 3681", "Ibn Hisham, Sirah"]', 5
...
He went straight to the Prophet, but not with his sword raised in violence. He went to declare his faith. When the Muslims heard Umar''s voice outside, they were terrified -- until Hamza said, "Let him in. If he comes with good intention, we will welcome him. If not, we will deal with him."
...
'["Quran 20:14", "Sahih al-Bukhari 3863", "Ibn Hisham, Sirah"]', 5
FROM sahaba WHERE slug = 'umar';
...
At the Battle of Badr, when the question of what to do with prisoners arose, Umar counseled severity while Abu Bakr counseled mercy. The Quran supported Umar''s position.
...
'["Jami at-Tirmidhi 3686", "Sahih al-Bukhari 402", "Sahih al-Bukhari 3294"]', 5
FROM sahaba WHERE slug = 'umar';
...
He created the first formal treasury (Bayt al-Mal), established stipends for all citizens -- including non-Muslims under Islamic protection. He created a census, organized the military into formal divisions, established the Islamic calendar, and built the first system of public works.
...
He famously said to the Nile River when a governor asked permission to sacrifice a girl to it (a pre-Islamic custom): "In the name of Allah -- flow." And it flowed.

When he conquered Jerusalem, he entered the city not on a horse or in royal garments, but walking on foot beside his servant who rode the camel. The Christian patriarch, having expected a conquering emperor draped in gold, was astonished. Umar refused to pray inside the Church of the Holy Sepulchre, saying: "If I pray here, the Muslims after me will claim this as a mosque." He prayed outside instead, protecting the church for future generations.',
'["Al-Tabari, Tarikh", "Ibn al-Jawzi, Manaqib Umar", "Sahih al-Bukhari"]', 5
FROM sahaba WHERE slug = 'umar';
...
The Prophet (peace be upon him) had said: "Among the nations before you, there were people who were spoken to (by Allah) without being prophets. If there is anyone of such in my Ummah, it is Umar." (Sahih al-Bukhari 3689)
...
'["Sahih al-Bukhari 3700", "Sahih al-Bukhari 3689", "Ibn Sa''d, Tabaqat"]', 5
FROM sahaba WHERE slug = 'umar';
...
VALUES (
  ...
  'Pre-Islamic - Early Revelation',
  'The first person to accept Islam, the Prophet''s beloved wife, and the woman whose wealth, wisdom, and unwavering support sustained the early Muslim community through its darkest years.',
  'heart',
  'text-[#8B2252]',
  'bg-[#8B2252]/10',
  4,
...
'["Ibn Hisham, Sirah", "Ibn Sa''d, Tabaqat"]', 4
...
'["Sahih al-Bukhari 3", "Sahih al-Bukhari 3818", "Musnad Ahmad"]', 4
FROM sahaba WHERE slug = 'khadijah';
...
'["Sahih al-Bukhari 3820", "Sahih Muslim 2432"]', 4
FROM sahaba WHERE slug = 'khadijah';
...
The Prophet (peace be upon him) said: "The best of its women is Maryam bint Imran, and the best of its women is Khadijah bint Khuwaylid."',
'["Sahih al-Bukhari 3818", "Sahih Muslim 2435", "Sahih al-Bukhari 3815", "Sahih al-Bukhari 3432"]', 4
FROM sahaba WHERE slug = 'khadijah';
...
VALUES (
  ...
  'بلال بن رباح',
  'The Voice of Islam',
  'Early Islam - Companion',
  'Born into slavery in Mecca, Bilal endured unimaginable torture for his faith and rose to become the first muezzin of Islam, the man whose voice called the entire Muslim world to prayer.',
  'star',
  'text-[#4A3080]',
  'bg-[#4A3080]/10',
  4,
...
'["Ibn Hisham, Sirah", "Sahih al-Bukhari 3544"]', 4
...
The Prophet said to Bilal: "O Bilal, I entered Paradise and heard the sound of your footsteps before me. What is it that you do?" Bilal replied: "I do not know, except that whenever I perform ablution at any time of night or day, I pray with that ablution whatever Allah wills for me to pray."

His devotion was constant -- not dramatic, not showy, but unceasing.',
'["Sahih al-Bukhari 3544", "Sahih al-Bukhari 1149", "Sahih Muslim 2458"]', 4
FROM sahaba WHERE slug = 'bilal';
...
Some of the Quraysh nobles, still processing their defeat, muttered in disgust. Abu Sufyan''s own companions grumbled about "this Black slave" calling from atop their sacred house.

But this was precisely the point. Islam had come to shatter every hierarchy built on lineage, wealth, or color. The Prophet (peace be upon him) said in his Farewell Sermon: "An Arab has no superiority over a non-Arab, nor does a non-Arab have any superiority over an Arab. A white has no superiority over a black, nor does a black have any superiority over a white -- except by piety and good action."
...
'["Sahih al-Bukhari 4286", "Musnad Ahmad 23536"]', 4
FROM sahaba WHERE slug = 'bilal';

INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 4, 'The Voice Falls Silent',
'After the Prophet (peace be upon him) passed away, Bilal could not bear to call the Adhan in Medina. Every time he tried, he would reach the words "Ashhadu anna Muhammadan Rasulullah" (I bear witness that Muhammad is the Messenger of Allah) and break down weeping, unable to continue. The memories were too overwhelming.

He asked Abu Bakr for permission to leave Medina and go to Syria for jihad. He spent the rest of his life serving Islam on the frontier, rarely returning to Medina.

But once, years later, he returned to visit the Prophet''s tomb. The people of Medina, who had missed his voice terribly, begged him to call the Adhan one last time. Bilal climbed to his old place and began.
...
'["Ibn Sa''d, Tabaqat", "Ibn Kathir, al-Bidayah", "Siyar A''lam an-Nubala"]', 4
FROM sahaba WHERE slug = 'bilal';
...
VALUES (
  ...
  'سلمان الفارسي',
  'The Seeker of Truth',
  'Pre-Islamic - Companion',
  'A Persian Zoroastrian who traveled across the entire known world -- from Persia through Christian monasteries in Syria and Iraq -- searching for the truth, until he finally found it with the Prophet Muhammad (peace be upon him) in Medina.',
  'users',
  'text-[#2563EB]',
  'bg-[#2563EB]/10',
  4,
...
One day, while running an errand for his father, Salman passed by a Christian church and heard the sound of prayer. He entered, and something stirred in his soul. The monotheism of the Christians -- their worship of One God -- resonated with the questions burning inside him.
...
His journey of seeking had begun.',
'["Musnad Ahmad 23737", "Ibn Hisham, Sirah"]', 4
FROM sahaba WHERE slug = 'salman';

INSERT INTO story_parts (sahaba_id, part_number, title, body, hadith_refs, total_parts)
SELECT id, 2, 'Through the Monasteries',
'For years -- possibly decades -- Salman traveled from one Christian monastery to another across the Middle East. In Syria, he served a bishop who he initially believed to be devout but who turned out to be corrupt, hoarding charity meant for the poor. When that bishop died, Salman served his successor, who was genuinely righteous.

When this second teacher was dying, Salman asked: "Who do you recommend I go to?" The monk directed him to another scholar in Mosul. Salman traveled to Mosul and served there until that teacher too was on his deathbed, who sent him to a scholar in Nusaybin, who sent him to another in Ammuriyyah (in modern Turkey).
...
'["Musnad Ahmad 23737", "Sahih Muslim"]', 4
FROM sahaba WHERE slug = 'salman';
...
This statement was extraordinary. The Prophet was not merely saying Salman was a Muslim -- he was saying this Persian former slave, this man with no Arab blood, was family.
...
Salman lived a long life, reportedly reaching over 80 years of age. He served as the governor of Ctesiphon (the former Persian capital), where he lived in extreme simplicity despite ruling one of the richest cities in the world. He would weave baskets and sell them for his food, giving his entire governor''s salary to charity.

When he died, they found that he owned nothing except a bowl, a water vessel, and a reed mat.

His journey -- from Zoroastrian fire temple to Christian monastery to Arabian slavery to the inner circle of the Prophet -- stands as the ultimate testament that truth belongs to no race, no culture, and no nation. It belongs to whoever is sincere enough to seek it, no matter how long or how far the journey takes.',
'["Sahih al-Bukhari 3793", "Musnad Ahmad 23737", "Ibn Sa''d, Tabaqat"]', 4
FROM sahaba WHERE slug = 'salman';

-- Seed shareable snippets
INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'I never invited anyone to Islam but that he showed some reluctance -- except Abu Bakr. When I presented Islam to him, he did not hold back or hesitate.', 'Sahih al-Bukhari 3661', 2
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Do not grieve; indeed Allah is with us.', 'Quran 9:40', 3
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Whoever worshipped Muhammad, let him know that Muhammad has died. And whoever worshipped Allah, let him know that Allah is Ever-Living and shall never die.', 'Sahih al-Bukhari 3667', 4
FROM sahaba WHERE slug = 'abu-bakr';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'We could not pray openly at the Ka''bah until Umar embraced Islam. His Islam was a conquest.', 'Ibn Hisham, Sirah', 2
FROM sahaba WHERE slug = 'umar';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Will you carry my burden on the Day of Judgment?', 'Al-Tabari, Tarikh', 4
FROM sahaba WHERE slug = 'umar';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Tomorrow we shall meet the beloved ones -- Muhammad and his companions.', 'Ibn Sa''d, Tabaqat', 4
FROM sahaba WHERE slug = 'bilal';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Never! By Allah, Allah will never disgrace you. You keep good relations with your family, you bear the burden of the weak, you help the poor.', 'Sahih al-Bukhari 3', 2
FROM sahaba WHERE slug = 'khadijah';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'She believed in me when no one else did. She accepted Islam when people rejected me. She supported me with her wealth when people deprived me.', 'Sahih al-Bukhari 3818', 4
FROM sahaba WHERE slug = 'khadijah';

INSERT INTO shareable_snippets (sahaba_id, text, hadith_ref, part_number)
SELECT id, 'Salman is from us, the People of the House.', 'Sahih al-Bukhari 3793', 4
FROM sahaba WHERE slug = 'salman';
